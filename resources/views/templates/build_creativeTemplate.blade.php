...
@section('customJs')
    <script>
        $(document).ready(function () {
            ...
            $('#propText').on('input', e => { const obj = canvas.getActiveObject(); if (obj) { obj.text = e.target.value; canvas.renderAll(); saveState(); } });
            $('#propFont').on('change', e => { const obj = canvas.getActiveObject(); if (obj) { obj.fontFamily = e.target.value; canvas.renderAll(); saveState(); } });
            $('#propFontSize').on('input', e => { const obj = canvas.getActiveObject(); if (obj) { obj.fontSize = parseInt(e.target.value); canvas.renderAll(); saveState(); } });
            $('#propColor').on('input', e => { const obj = canvas.getActiveObject(); if (obj) { obj.set('fill', e.target.value); canvas.renderAll(); saveState(); } });
            $('#propOpacity').on('input', e => { const obj = canvas.getActiveObject(); if (obj) { obj.opacity = parseFloat(e.target.value); canvas.renderAll(); saveState(); } });

            $('#alignLeft').on('click', () => { const obj = canvas.getActiveObject(); if (obj) { obj.textAlign = 'left'; canvas.renderAll(); } });
            $('#alignCenter').on('click', () => { const obj = canvas.getActiveObject(); if (obj) { obj.textAlign = 'center'; canvas.renderAll(); } });
            $('#alignRight').on('click', () => { const obj = canvas.getActiveObject(); if (obj) { obj.textAlign = 'right'; canvas.renderAll(); } });

            $('#bringForward').on('click', () => { const obj = canvas.getActiveObject(); if (obj) canvas.bringForward(obj); });
            $('#sendBack').on('click', () => { const obj = canvas.getActiveObject(); if (obj) canvas.sendBackwards(obj); });
            $('#deleteObject').on('click', () => { const obj = canvas.getActiveObject(); if (obj) { canvas.remove(obj); saveState(); } });
            ...
            function exportCanvas() {
                ...
                const exportCanvas = new fabric.StaticCanvas(null, { width, height });
                if (canvas.backgroundImage) {
            ...
            $('#saveTemplateBtn').on('click', function () {
                ...
                const json = JSON.stringify(canvas.toJSON(['selectable', 'id']));
                const payload = {
                    title: title,
                    json: json,
                    exportedImage: exportCanvas()
                };
