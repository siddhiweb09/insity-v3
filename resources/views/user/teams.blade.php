                            ...
                            @foreach($teams as $team)
                                <div class="col-lg-4 col-md-6 col-12 mb-4 d-flex">
                                    <div
                                        ...
                                        <img src="{{ asset('assets/images/profile_picture/teams.png') }}" class="card-img-top mt-3"
                                            alt="Counselor Image">
                                        <div class="card-body">
                                            ...
                                            <div class="mt-2">
                                                ...
                                                <a href="{{ route('user.user_mapping', ['encoded' => base64_encode($team->id . '*' . $team->team_name . '*' . $team->team_leader . '*' . $team->group_name)]) }}"
